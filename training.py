...
from models.gat_gcn_mix import GAT_GCN

from models.gcn import GCNNet
from models.ginconv import GINConvNet
from models.ginconv_2D import GINConvNet_2D
from utils import *
...
datasets = ['davis','kiba']#,
modeling = [ GAT_GCN]# GINConvNet,GATNet,GCNNet,
    ...
    if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test))):
        ...
        for m in modeling:
            ...
            for epoch in range(NUM_EPOCHS):
                ...
                if (epoch + 1) >= 800 :#and (epoch + 1) % 20 == 0:
                    # if (epoch+1) i
